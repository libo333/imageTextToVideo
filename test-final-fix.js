        ...
        const workflow = {
            "1": {
                "inputs": {
                    ...
                    "image_output": "Hide",
                    "save_prefix": `ComfyUI_${timestamp}_${Math.floor(Math.random() * 1000)}`
                },
            ...
            "8": {
                "inputs": {
                    ...
                    "frame_rate": 6,
                    "loop_count": 0,
                    "filename_prefix": `svd_video_${timestamp}`,
            ...
            try {
                ...
                if (history) {
                    ...
                    if (pollCount === 1 || pollCount % 5 === 0) {
                        ...
                        const executionCached = messages.find(m => m[0] === 'execution_cached');
                        const cachedNodes = executionCached ? executionCached[1].nodes || [] : [];

                        console.log(`⏳ [${pollCount}s] 状态: ${status} | 缓存节点数: ${cachedNodes.length}`);
                    }
